			...
			<div class="card card-default">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						{!! Form::select('province', $provinces, $shipment->province, ['id' => 'province-id', 'class' => 'form-control', 'disabled' => true]) !!}
					</div>
					<div class="form-group row">
						<div class="col-md-6">
							{!! Form::label('city', 'City') !!}
							{!! Form::select('city', $cities, $shipment->city, ['id' => 'city-id', 'class' => 'form-control', 'disabled' => true])!!}
						</div>
						<div class="col-md-6">
