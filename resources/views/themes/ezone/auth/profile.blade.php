					...
					<div class="login">
						<div class="login-form-container">
							<div class="login-form">
									...
									<div class="form-group row">
										<div class="col-md-6">
											{!! Form::select('province', $provinces, Auth::user()->province, ['id' => 'user-province-id', 'placeholder' => '- Please Select - ', 'required' => true]) !!}
											@error('province')
												<span class="invalid-feedback" role="alert">
													<strong>{{ $message }}</strong>
												</span>
										...
										<div class="col-md-6">
											{!! Form::select('city', $cities, null, ['id' => 'user-city-id', 'placeholder' => '- Please Select -', 'required' => true])!!}
											@error('city')
												<span class="invalid-feedback" role="alert">
													<strong>{{ $message }}</strong>
												</span>
